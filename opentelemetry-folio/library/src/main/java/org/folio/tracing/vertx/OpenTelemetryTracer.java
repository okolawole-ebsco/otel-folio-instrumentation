...
class OpenTelemetryTracer implements VertxTracer<Scope, Scope> {
  ...
  public <R> Scope receiveRequest(
    ...
    return VertxContextStorage.getInstance().attach(
  ...
  public <R> void sendResponse(
    ...
    Span span = Span.fromContext(context.getLocal(VertxContextStorage.ACTIVE_CONTEXT));
  ...
  public <R> Scope sendRequest(
    ...
    return VertxContextStorage.getInstance().attach(context, tracingContext);
  }
